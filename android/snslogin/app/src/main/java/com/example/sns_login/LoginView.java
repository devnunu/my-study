...
public class LoginView extends Activity {
     ...
     * client 정보를 넣어준다.
     */
    private static String OAUTH_CLIENT_ID = "_auGB_ljYdT48Az4pQrN";
    private static String OAUTH_CLIENT_SECRET = "cwRypoMUUF";
    private static String OAUTH_CLIENT_NAME = "테스트";
    ...
    public void onButtonClick(View v) throws Throwable {
        ...
        switch (v.getId()) {
            case R.id.buttonOAuth: {
                mOAuthLoginInstance.startOauthLoginActivity(LoginView.this, mOAuthLoginHandler);
                break;
            }
